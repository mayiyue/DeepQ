...
extern "C" {
	...
	struct AAPIEXPORT A2KSubPathProportion {
		...
		A2KSubPathProportion( int nbSections, int *subpath, double aPercentage )
		{
	...
	struct AAPIEXPORT A2KDestinationProportion {
		...
		A2KDestinationProportion( int aNewDest, double aPercentage, int nbSubpaths, A2KSubPathProportion *subpaths )
		{
			this->newDest = aNewDest;
			this->percentage = aPercentage;
			this->nbSubpaths = nbSubpaths;
		...
		double percentage;
		int nbSubpaths;
		A2KSubPathProportion *subpaths;
	};

	AAPIEXPORT void * AKIActionAddForceTurningODActionByID( int idAction, int sectionId, int nbNextSections, A2KDestinationProportion *aNextSections, int aOrigin, int aDest, int vehType, int aSectionInPath, double aComplianceLevel, double visibilityDistance );
	AAPIEXPORT void * AKIActionAddForceTurningODSubPathActionByID( int idAction, int sectionId, int nbNextSections, A2KDestinationProportion *aNextSections, int aOrigin, int aDest, int vehType, int aSectionInPath, double aComplianceLevel, double visibilityDistance );
	AAPIEXPORT void * AKIActionAddForceTurningResultActionByID( int idAction, int sectionId, int aOldNextSection, int nbNewNextSections, A2KDestinationProportion *aNewNextSections, int  vehType, double aComplianceLevel );
	AAPIEXPORT void * AKIActionAddForceTurningResultSubPathActionByID( int idAction, int sectionId, int nbNewNextSections, A2KDestinationProportion *aNewNextSections, int vehType, double aComplianceLevel );
	...
	struct AAPIEXPORT StaticInfVeh{
		...
		//! factors for acceleration and deceleration for modelling capacity drop
		double AStateFactor;
		double BStateFactor;
...
//	AAPIEXPORT int AKIVehTypeSetSensitivityForImprudentLaneChanging( int idVehicleType, double newSensitivity );
	...
	struct AAPIEXPORT A2KSectionInf{
		...
		//! if the imprudent lane-changing behaviour is activated in this section.
